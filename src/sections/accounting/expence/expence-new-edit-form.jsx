    ...
    try {
      if (currentExpense) {
        const res = await axios.put(
          `${import.meta.env.VITE_BASE_URL}/${user?.company?._id}/expense/${currentExpense._id}`,
          formData
        );
        router.push(paths.dashboard.accounting.expense.list);
        enqueueSnackbar(res?.data.message);
        reset();
      } else {
        const res = await axios.post(
          `${import.meta.env.VITE_BASE_URL}/${user?.company?._id}/expense`,
          formData
        );
        router.push(paths.dashboard.accounting.expense.list);
        enqueueSnackbar(res?.data.message);
