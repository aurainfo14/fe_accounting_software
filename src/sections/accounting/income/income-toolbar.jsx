...
import IncomePdf from './view/income-pdf.jsx';
...
export default function IncomeToolbar({ filters, onFilters, options, dateError, incomeData }) {
  ...
  const isTablet = useMediaQuery(theme.breakpoints.down('mb'));
        ...
        <Box sx={{ height: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <Box sx={{ flexGrow: 1, height: 1, overflow: 'hidden' }}>
            <PDFViewer width="100%" height="100%" style={{ border: 'none' }}>
              <IncomePdf incomeData={incomeData} configs={configs} filterData={filterData} />
            </PDFViewer>
          </Box>
        </Box>
      </Dialog>
